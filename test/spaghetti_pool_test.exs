defmodule SpaghettiPoolTest do
  ...
  test "pool is unlocked if locking process crashes during pending lock", %{name: name, pid: pid} do
    [r1, r2] = Util.workers(2)
